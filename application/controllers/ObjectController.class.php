...
class ObjectController extends ApplicationController
{
            ...
            foreach ($subscribers as $key => $checked) {
                ...
                if ($checked == "checked") {
                    ...
                    if ($user instanceof User) {
                        ...
                        //print_r($object->getTitle());
                        $sms_obj = new SmsController();
                        $sms_obj->prepareTaskSms($user->getDisplayName(), $object->getTitle());
    ...
    function link_object()
    {
        ...
        try {
            ...
            $succ = 0;
            $err = 0;
            $permission_err = false;
            $object_dnx_err = false;
    ...
    { // ex detach_from_object() {
        ...
        try {
            ...
            foreach ($objects_to_unlink as $obj) {
                ...
                if (!($linked_object instanceof LinkedObject)) { //search for reverse link
                    $linked_object = LinkedObjects::findById(array(
